...
class BrandDelete(StaffRequiredMixin, TestMixinUserEmail, DeleteView):
    ...
    template_name = "staff/dashboard/brand/list." + app_settings.TEMPLATE_EXTENSION
...
class BrandUpdate(StaffRequiredMixin, TestMixinUserEmail, UpdateView):
    ...
    template_name = "staff/dashboard/brand/update." + app_settings.TEMPLATE_EXTENSION
    login_url = reverse_lazy("account_login")
    model = Brands
    success_url = reverse_lazy("staff-brand-list")
...
class BrandDetail(StaffRequiredMixin, TestMixinUserEmail, DetailView):
    ...
    template_name = "staff/dashboard/brand/detail." + app_settings.TEMPLATE_EXTENSION
    extra_context = {
        "app_data": Sites.objects.all(),
        "pagename": "Brand",
        "page_titel": app_settings.PAGE_TITLE,
...
class BrandCreate(StaffRequiredMixin, TestMixinUserEmail, CreateView):
    ...
    template_name = "staff/dashboard/brand/create." + app_settings.TEMPLATE_EXTENSION
    login_url = reverse_lazy("account_login")
    model = Brands
    form_class = BrandForm
    initial = {"key": "value"}
