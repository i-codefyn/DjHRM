...
from pages.models import FeedBack, ContactUs, OnlineApplication
...
class StaffView(StaffRequiredMixin, TestMixinUserEmail, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["site_name"] = app_settings.SITE_NAME
        context["page_title"] = app_settings.PAGE_TITLE
        ...
        context["form_count"] = OnlineApplication.objects.count()
        return context
...
class UserAcountView(LoginRequiredMixin, TemplateView):
    ...
    extra_context = {"page_title": "User Account", "app_data": Sites.objects.all()}
