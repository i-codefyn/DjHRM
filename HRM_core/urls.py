...
admin_site.register(SliderData)
admin_site.register(Brands)
admin_site.register(Faq)
admin_site.register(Features)
admin_site.register(KeywordDiscription)
admin_site.register(Sites)
admin_site.register(GoogleFeeds)
admin_site.register(OurClients)
...
admin.site.site_header = "Codefyn HRM"
admin.site.site_title = "Codefyn HRM Portal"
admin.site.index_title = "Welcome to Codefyn HRM"
urlpatterns = [
